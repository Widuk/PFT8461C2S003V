...
namespace WindowsFormsApp1
{
    public partial class PortadaMantenedorProducto : Form
    {
        ...
        public void cargaProductos()
        {
            ...
            dtgListaPreducto.Columns[5].HeaderText = "SKU";
            dtgListaPreducto.Columns[6].HeaderText = "Activo";
            dtgListaPreducto.Columns[6].Visible = false;
            dtgListaPreducto.Columns[7].HeaderText = "F.Creación";
            dtgListaPreducto.Columns[8].HeaderText = "F.Modificación";
            dtgListaPreducto.Columns[9].HeaderText = "Rubro";
        ...
        public void dtgListaPreducto_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            objetoPaso.paso5 = filaSeleccionada.Cells[5].Value.ToString();  //SKU
            objetoPaso.paso6 = filaSeleccionada.Cells[6].Value.ToString();  //estado
            objetoPaso.paso7 = filaSeleccionada.Cells[7].Value.ToString();  //fechaCreacion
            objetoPaso.paso8 = filaSeleccionada.Cells[8].Value.ToString();  //FechaModificacion
            objetoPaso.paso9 = filaSeleccionada.Cells[9].Value.ToString();  //Tienda
            objetoPaso.paso10 = filaSeleccionada.Cells[10].Value.ToString();//Rubro
        }
